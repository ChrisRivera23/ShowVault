enum RecoveryRunStatus { pending, inProgress, completed, failed, expired }

enum RecoveryStageKind { scan, backup, verify, restore }

enum RecoveryStageStatus {
  notStarted,
  pending,
  inProgress,
  completed,
...
class RecoveryRun {
  ...
  static RecoveryRunStatus _runStatus(String value) => switch (value) {
    ...
    'expired' => RecoveryRunStatus.expired,
...
class RecoveryStage {
  ...
  factory RecoveryStage.fromJson(Map<String, Object?> json) => RecoveryStage(
    ...
    status: switch (json['status']) {
      ...
      'expired' => RecoveryStageStatus.expired,
