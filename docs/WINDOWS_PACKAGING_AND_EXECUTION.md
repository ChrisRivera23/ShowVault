...
A fresh bridge branch from exact `main` `b6d5aff28a310f3ccc3d7a6e1b38c2589170d5fa` contains commit `35b5d68b6a3bb5e25a3a240186b173a6582fba13`. It changes only `.github/workflows/windows-evidence.yml`, pins exact source `cf76d62a867c3c3918cfb0200d429d84e9c9503a`, and independently verifies at SHA-256 `d2dc4893d11baba531e4e9aada3dbe295db47801495f7c7d177959ebfb383bc9`. All 32 focused packaging/bridge/evidence tests and the diff check pass. Draft PR #30 publishes that exact bridge; push run `31450492324` and pull-request run `31450509600` passed all four API/Flutter jobs. The PR remains draft, and no merge, new dispatch, or artifact exists from this correction.
