    ...
    TimeProvider timeProvider) : ExactRootFileDiscoveryPluginBase(options, timeProvider)
{
    ...
    protected override IReadOnlyList<string> ConfiguredRoots => Options.MidasProShowRoots;

    protected override string ProductName => "Midas PRO Series/XL8";
