...
3. Merge only exact reviewed bridge head `813eec9d5719f34e2e4f621f007d498b83e9e558` after revalidating every recorded invariant, use an expected-head guard, wait for automatic `main` CI, and do not invoke `verify_windows_run.dart` for failed run `31470709633`.
