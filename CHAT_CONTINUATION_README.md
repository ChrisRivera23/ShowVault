...
The replacement bridge is prepared and independently verified locally at exact commit `813eec9d5719f34e2e4f621f007d498b83e9e558`. After explicit authorization, the next bounded objective is to publish that exact bridge with an old-head lease from remote bridge `ed9c36fd4db8553429d9e75d34c9ccafc245fcb5`, create a draft bridge PR targeting exact `main` `46dab66400d9201beb13e067e6f9d814ee00294a`, and wait for its push and pull-request CI. Stop before ready transition, merge, Windows workflow dispatch/rerun, artifact retrieval, or equipment access.
...
3. Publish only exact bridge commit `813eec9d5719f34e2e4f621f007d498b83e9e558` after revalidating live base/product/bridge refs, use the exact old-head lease, create only a draft PR targeting `main`, wait for exact push and pull-request CI, and do not invoke `verify_windows_run.dart` for failed run `31470709633`.
