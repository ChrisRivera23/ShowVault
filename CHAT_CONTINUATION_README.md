...
The owned-result-channel correction is published and green at exact source `229f14ca5a20743e350903974e0d77831e39b4ae`. After explicit authorization, the next bounded objective is local-only deterministic bridge preparation and independent verification from exact `main` `a900fd4a57392612e791acfaebdd3d09f31cd5ea`, pinning that source. Stop before bridge push, PR creation/mutation, merge, Windows workflow dispatch/rerun, artifact retrieval, or equipment access.
...
3. Prepare a fresh local bridge branch/worktree directly from exact `main` `a900fd4a57392612e791acfaebdd3d09f31cd5ea`, deterministically pin exact green source `229f14ca5a20743e350903974e0d77831e39b4ae`, independently verify byte identity and digest before and after a bridge-only commit, and do not invoke `verify_windows_run.dart` for failed run `31467029026`.
