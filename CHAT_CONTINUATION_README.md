...
After explicit authorization for local bridge preparation, revalidate unchanged `main` `b6d5aff28a310f3ccc3d7a6e1b38c2589170d5fa`, published green source `cf76d62a867c3c3918cfb0200d429d84e9c9503a`, remote bridge head `a307e5499d3396027bcc67fc4856ff236542fb31`, and deterministic digest `d2dc4893d11baba531e4e9aada3dbe295db47801495f7c7d177959ebfb383bc9`. Create a fresh bridge worktree/branch from exact `main`, prepare and independently verify the one-file workflow, and commit it locally. Stop before bridge push/PR mutation, ready/merge, workflow dispatch, or artifact retrieval.

The next slice must satisfy these boundaries:

1. Four authorized Windows evidence runs now exist and all failed at distinct bounded gates. None is authorized for rerun. The immutable vcpkg source correction is published and green at exact commit `cf76d62`; local bridge preparation is next, while bridge publication, merge, dispatch, and artifact gates remain separate.
