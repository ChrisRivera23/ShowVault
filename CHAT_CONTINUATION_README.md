...
After explicit authorization for bridge publication/PR mutation, revalidate unchanged remote `main` `b6d5aff28a310f3ccc3d7a6e1b38c2589170d5fa`, product source `cf76d62a867c3c3918cfb0200d429d84e9c9503a`, remote bridge head `a307e5499d3396027bcc67fc4856ff236542fb31`, local bridge commit `35b5d68b6a3bb5e25a3a240186b173a6582fba13`, one-file diff, and digest `d2dc4893d11baba531e4e9aada3dbe295db47801495f7c7d177959ebfb383bc9`. Push only that exact commit to `codex/windows-evidence-bridge` with the verified old-head lease, open a new draft bridge PR targeting `main`, record the exact identities and limitations, and wait for current push/PR CI. Stop before marking ready, merge, workflow dispatch, artifact retrieval, or equipment access.

The next slice must satisfy these boundaries:

1. Four authorized Windows evidence runs now exist and all failed at distinct bounded gates. None is authorized for rerun. The immutable vcpkg source correction is published and green at exact commit `cf76d62`; its exact one-file bridge is locally committed at `35b5d68`, while bridge publication/PR mutation, merge, dispatch, and artifact gates remain separate.
