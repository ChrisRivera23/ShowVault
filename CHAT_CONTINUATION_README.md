...
Establish an explicitly authorized path that places the versioned Windows evidence workflow on the default branch, then execute it once, or use explicitly authorized controlled Windows equipment.
