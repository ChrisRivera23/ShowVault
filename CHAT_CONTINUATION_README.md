...
The entry/exit diagnostic correction is published and green at exact source `4c2f58b638cd2c3fd6dd10dfa047b0e8c4538e02`. After explicit authorization, the next bounded objective is local-only deterministic bridge preparation and independent verification from exact `main` `46dab66400d9201beb13e067e6f9d814ee00294a`, pinning that source. Stop before bridge push, PR creation/mutation, merge, Windows workflow dispatch/rerun, artifact retrieval, or equipment access.
...
3. Prepare a fresh local bridge branch/worktree directly from exact `main` `46dab66400d9201beb13e067e6f9d814ee00294a`, deterministically pin exact green source `4c2f58b638cd2c3fd6dd10dfa047b0e8c4538e02`, independently verify byte identity and digest before and after a bridge-only commit, and do not invoke `verify_windows_run.dart` for failed run `31470709633`.
