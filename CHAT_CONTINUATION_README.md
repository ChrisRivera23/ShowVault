...
The replacement bridge is prepared and independently verified locally at exact commit `ed9c36fd4db8553429d9e75d34c9ccafc245fcb5`. After explicit authorization, the next bounded objective is to publish that exact bridge with an old-head lease from remote bridge `daeff1f3af1ef990c678579c4005d4bf9919ab4e`, create a draft bridge PR targeting exact `main` `a900fd4a57392612e791acfaebdd3d09f31cd5ea`, and wait for its push and pull-request CI. Stop before ready transition, merge, Windows workflow dispatch/rerun, artifact retrieval, or equipment access.
...
3. Publish only exact bridge commit `ed9c36fd4db8553429d9e75d34c9ccafc245fcb5` after revalidating the live base/product/bridge refs, use the exact old-head lease, create only a draft PR targeting `main`, wait for exact push and pull-request CI, and do not invoke `verify_windows_run.dart` for failed run `31467029026`.
