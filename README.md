...
- `codex/dante-controller-presets` — Dante Controller XML network presets and colocated recovery evidence.
...
13. Implement and pilot the approved Version 1 vendor integrations. — Resolume, grandMA, Yamaha, Q-SYS, ETC Eos, and Dante Controller foundations implemented
