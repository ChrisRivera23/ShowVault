...
- `codex/rcf-recovery-research` — RCF recovery-format research and explicit deferral pending a dependable local RDNet or RDShape artifact.
...
- Next recommended implementation step: continue the Version 1 integration catalog with JBL Professional while preparing a deployed-environment and real-venue pilot.
...
- Branch: `codex/rcf-recovery-research`
- Clean worktree after the RCF research-decision and README handoff commit
- Verified baseline: 236 Agent tests, 7 API tests, Flutter analysis, and 6 Flutter tests passing
- Next catalog target: JBL Professional
