...
- `codex/madmapper-catalog-detection` — official-source MadMapper 6 research and documented standard macOS/Windows application plus project-workspace detection.
...
- Next recommended implementation step: research official Isadora primary sources, then add catalog-driven installed-application and project-root detection only for documented stable standard locations with synthetic fixtures; if primary sources do not establish dependable paths, record an evidence-backed deferral instead of guessing or inspecting a real workstation.
