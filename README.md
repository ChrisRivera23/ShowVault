...
- Next operational target: official-source research followed by documented-path-only disguise Designer Windows application/project detection, or an evidence-backed deferral if stable locations are not published
