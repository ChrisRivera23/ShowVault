...
- `codex/yamaha-provisionaire-control` — editable Control PLUS projects and Kiosk controller recovery.
...
- Active implementation branch: `codex/yamaha-provisionaire-control`, stacked on PR #22. It requires an editable Control PLUS `.pvcppj` project and preserves exported `.pvksk` Kiosk controllers and companion assets.
