...
- `codex/grandma-show-backups` — distinct grandMA2 and grandMA3 USB/export recovery units.
...
- Active implementation branch: `codex/grandma-show-backups`, stacked on PR #16. It adds distinct exact-root grandMA2 and grandMA3 USB/export discovery and preserves their separate version-compatibility boundaries.
