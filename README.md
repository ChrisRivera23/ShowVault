...
- Next recommended implementation step: research official vMix primary sources for dependable automatic local application and recoverable-data roots for the streaming-and-production catalog. Preserve the existing catalog-driven, path-free control-plane boundary; do not infer support from process names, generic files, user-entered paths, or undocumented platform conventions.
