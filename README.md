...
- `codex/funktion-one-recovery-research` — Funktion-One/NST Audio D-Net recovery-format research and explicit deferral pending a dependable project artifact.
...
- Next recommended implementation step: continue the Version 1 integration catalog with Adamson while preparing a deployed-environment and real-venue pilot.
...
- Branch: `codex/funktion-one-recovery-research`
- Clean worktree after the Funktion-One research-decision and README handoff commit
- Verified baseline: 248 Agent tests, 7 API tests, Flutter analysis, and 6 Flutter tests passing
- Next catalog target: Adamson
