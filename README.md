...
- `codex/powersoft-armoniaplus-projects` — Powersoft ArmoníaPlus `.paw4` projects and recovery companions.
...
- Next recommended implementation step: continue the professional-audio manufacturer wave with Crown Audio Architect venue files, while leaving Crest deferred pending a verified native fixture.
