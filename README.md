...
- `codex/isadora-catalog-detection` — official-source Isadora 4 research and documented usual macOS/Windows installed-application detection.
...
- Next recommended implementation step: research official Ventana primary sources, then add catalog-driven installed-application and project-root detection only for documented stable standard locations with synthetic fixtures; if primary sources do not establish dependable paths, record an evidence-backed deferral instead of guessing or inspecting a real workstation.
