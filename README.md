...
- The authoritative Version 1 catalog spans professional audio, audio networking/DSP, lighting platforms/protocols, video/media servers, and projection; Resolume, Yamaha, and grandMA2/grandMA3 are highest priority.
...
- The Product Owner supplied the authoritative Version 1 venue-technology scope in `docs/INTEGRATION_CATALOG.md`. Resolume, Yamaha, and grandMA2/grandMA3 are highest priority. Coverage is tracked per tested product/model or protocol capability; empty catalog plugins and generic reachability do not qualify.
