...
- `codex/calrec-apollo-artemis-shows` — Calrec Apollo/Artemis native show exports and recovery companions.
...
13. Implement and pilot the approved Version 1 vendor integrations. — Priority and representative foundations implemented; remaining professional-audio manufacturer wave now covers DiGiCo SD/Quantum, SSL Live, Lawo mc², and Calrec Apollo/Artemis
...
- Next recommended implementation step: continue the professional-audio manufacturer wave with Studer after verifying its current console export formats, recovery unit boundaries, and model/software compatibility from official documentation.
