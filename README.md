...
- `codex/heavym-catalog-research` — official-source HeavyM location research and deliberate deferral pending documented standard paths.
...
- Next recommended implementation step: research official MadMapper primary sources, then add catalog-driven installed-application and project-root detection only for documented stable standard locations with synthetic fixtures; if primary sources do not establish dependable paths, record an evidence-backed deferral instead of guessing or inspecting a real workstation.
