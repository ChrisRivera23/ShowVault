...
- `codex/ventuz-catalog-research` — official-source Ventuz location research and deliberate deferral pending documented standard paths.
...
- Next recommended implementation step: research official Christie Pandoras Box primary sources, then add catalog-driven installed-application and project-root detection only for documented stable standard locations with synthetic fixtures; if primary sources do not establish dependable paths, record an evidence-backed deferral instead of guessing or inspecting a real workstation.
...
- Next operational target: official-source research followed by documented-path-only Christie Pandoras Box application/project detection, or an evidence-backed deferral if stable locations are not published
