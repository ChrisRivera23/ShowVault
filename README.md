...
- `codex/yamaha-dsp-projects` — DME7 ProVisionaire Design and MTX/MRX Editor project recovery.
...
- Next implementation step: define the next evidence-backed Yamaha recovery target, beginning with PC-D/DI amplifier projects in ProVisionaire Design while preserving a separate tested model/version compatibility record from DME7.
