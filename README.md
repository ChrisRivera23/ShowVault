...
- Active implementation branch: `codex/yamaha-dme5-dme3`, stacked on PR #23. It adds DME5/DME3 as a separate ProVisionaire Design `.pvd` compatibility target and preserves Custom Control Panel exports as companions.
